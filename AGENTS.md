...
- 文档/编码/命名：`docs/Obsidian/standards/doc/documentation-standards.md` · `docs/Obsidian/standards/coding-standards.md` · `docs/Obsidian/standards/naming-standards.md`
...
- 迁移脚本禁止修改历史版本（规则：`docs/Obsidian/standards/backend/database-migrations.md`）
- 后台任务必须运行在 Flask `app.app_context()` 内（规则：`docs/Obsidian/standards/backend/task-and-scheduler.md`）
- API 响应封套/错误口径遵循：`docs/Obsidian/standards/backend/layer/api-layer-standards.md`、`docs/Obsidian/standards/backend/error-message-schema-unification.md`
- 分支/提交：日常 PR → `dev`；发布/线上修复 → `main`（详见 `docs/Obsidian/standards/git-workflow-standards.md`）；提交前缀建议 `fix:`/`feat:`/`refactor:`/`docs:`/`chore:`（≤72 字）
