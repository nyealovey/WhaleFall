...
from app.schemas.query_parsers import parse_int, parse_optional_int_list, parse_text
...
class MySQLClusterListQuery(PayloadSchema):
    """MySQL 群集列表 query."""
...
class MySQLClusterCreatePayload(PayloadSchema):
    """创建 MySQL 群集 payload."""
...
class MySQLClusterUpdatePayload(PayloadSchema):
    """更新 MySQL 群集 payload."""
...
class MySQLClusterInstancesPayload(PayloadSchema):
    """整体替换 MySQL 群集实例绑定 payload."""
