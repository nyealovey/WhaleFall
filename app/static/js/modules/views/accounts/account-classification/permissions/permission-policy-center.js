(function (window, document) {
  ...
  class SQLServerPermissionStrategy extends PermissionStrategy {
    ...
    renderSelector(permissions = {}, prefix = "") {
      ...
      const serverPermissions = Array.isArray(permissions.server_permissions)
        ? permissions.server_permissions
        : [];
      const databasePermissions = Array.isArray(permissions.database_privileges)
  ...
  class PostgreSQLPermissionStrategy extends PermissionStrategy {
    ...
    renderSelector(permissions = {}, prefix = "") {
      ...
      const databasePrivileges = Array.isArray(permissions.database_privileges)
        ? permissions.database_privileges
        : [];
