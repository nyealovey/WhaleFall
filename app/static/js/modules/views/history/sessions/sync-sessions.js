  ...
  function initializeGridPage() {
    ...
    gridPage = GridPage.mount({
      ...
      plugins: [
        ...
        {
          onGridReady: ({ gridEl }) => {
            global.UI?.applyProgressBars?.(gridEl);
          },
          onGridUpdated: ({ gridEl }) => {
            global.UI?.applyProgressBars?.(gridEl);
          },
        },
      ],
    ...
    return gridHtml(`
      <div class="session-progress">
        <div class="progress wf-progress wf-progress--md">
          <div class="${barClass}" role="progressbar" data-progress-percent="${successRate}" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
