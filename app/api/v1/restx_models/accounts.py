...
ACCOUNT_LEDGER_ITEM_FIELDS = {
    ...
    "ad_status": fields.String(description="AD 状态", example="disabled"),
    "ad_domain": fields.String(description="AD NetBIOS 域名", example="CORP"),
    "ad_disabled_at": fields.String(description="AD 停用标记时间", example="2026-05-21T01:30:00+08:00"),
    "ad_orphaned_at": fields.String(description="AD 孤账户标记时间", example=None),
    "last_change_time": fields.String(description="最后变更时间(ISO8601, 可选)", example="2025-01-02T00:00:00"),
    "availability_reasons": fields.List(fields.String(), description="账户不可用原因", example=["账户已禁用"]),
...
ACCOUNT_STATISTICS_FIELDS = {
    ...
    "ag_virtual_instances": fields.Integer(description="AG 虚拟实例数", example=1),
