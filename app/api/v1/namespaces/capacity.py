...
_capacity_databases_query_parser.add_argument("instance_id", type=int, action="append", location="args")
_capacity_databases_query_parser.add_argument("db_type", type=str, action="append", location="args")
...
_capacity_instances_query_parser.add_argument("instance_id", type=int, action="append", location="args")
_capacity_instances_query_parser.add_argument("db_type", type=str, action="append", location="args")
