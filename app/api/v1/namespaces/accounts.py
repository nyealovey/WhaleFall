...
AccountStatisticsStatsModel = ns.model(
    "AccountStatisticsStats",
    {
        ...
        "owner_type_stats": fields.Raw(),
        "ad_status_stats": fields.Raw(),
        "database_instances": fields.Integer(),
        "total_instances": fields.Integer(),
        "physical_instances": fields.Integer(),
        "ag_virtual_instances": fields.Integer(),
...
_accounts_filters_query_parser.add_argument("owner_id", type=int, location="args")
