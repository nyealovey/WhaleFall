...
class QueryProtocol(Protocol[T_co]):
    ...
    def outerjoin(self, *args: object, **kwargs: object) -> QueryProtocol[T_co]:
        """协议方法: 左外连接记录."""
        ...
    ...
    def group_by(self, *args: object, **kwargs: object) -> QueryProtocol[T_co]:
        """协议方法: 分组记录."""
        ...
    ...
    def offset(self, count: int) -> QueryProtocol[T_co]:
        """协议方法: 设置查询偏移量."""
        ...
    ...
    def distinct(self, *args: object) -> QueryProtocol[T_co]:
        """协议方法: 去重记录."""
        ...
    ...
    def scalar(self) -> T_co:
        """协议方法: 返回标量结果."""
        ...

    def iter_rows(self) -> Iterable[T_co]:
        """协议方法: 迭代结果行."""
        ...
