...
class MySQLSyncAdapter(BaseSyncAdapter):
    ...
    def _parse_grant_statement(self, grant_statement: str, global_privileges: List[str], 
                              database_privileges: Dict[str, List[str]]) -> None:
        """
        解析GRANT语句
        """
        try:
