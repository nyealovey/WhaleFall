...
@database_ledger_bp.route("/ledger")
@login_required
...
@database_ledger_bp.route("/api/ledger", methods=["GET"])
@login_required
@view_required(permission="database_ledger.view")
...
@database_ledger_bp.route("/api/ledger/<int:database_id>/capacity-trend", methods=["GET"])
@login_required
@view_required(permission="database_ledger.view")
