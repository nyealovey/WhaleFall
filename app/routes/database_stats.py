...
def get_instance_database_sizes(instance_id: int) -> Response:
    ...
    try:
        if latest_only:
            stats_payload = _fetch_latest_database_sizes(instance_id, database_name, start_date_obj, end_date_obj, limit, offset)
        else:
            stats_payload = _fetch_historical_database_sizes(instance_id, database_name, start_date_obj, end_date_obj, limit, offset)
