...
echo "  - dbinfo.whalefall.local (HTTP -> HTTPS 重定向)"
echo "  - *.whalefall.local (HTTP -> HTTPS 重定向)"
...
echo "  - HTTP 端口: 80"
echo "  - HTTPS 端口: 443"
echo "  - 支持的域名: localhost, dbinfo.whalefall.local, *.whalefall.local"
...
echo "  - 域名访问: https://dbinfo.whalefall.local"
echo "  - 通配符域名: https://任意.whalefall.local"
