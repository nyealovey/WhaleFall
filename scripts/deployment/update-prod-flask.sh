...
show_update_result() {
    ...
    echo "  - 查看Gunicorn日志: docker compose -f docker-compose.prod.yml exec whalefall cat /var/log/gunicorn/access.log"
    echo "  - 查看Gunicorn错误日志: docker compose -f docker-compose.prod.yml exec whalefall cat /var/log/gunicorn/error.log"
