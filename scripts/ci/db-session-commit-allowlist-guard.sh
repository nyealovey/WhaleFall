...
# - infra: safe_route_call / queue worker / database batch manager
allowed_regex='^(app/infra/route_safety\.py:|app/infra/logging/queue_worker\.py:|app/infra/database_batch_manager\.py:|app/tasks/|scripts/)'
