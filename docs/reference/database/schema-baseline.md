...
> 创建：2025-12-19  
> 更新：2025-12-26  
> 范围：`sql/init/postgresql/**`、`migrations/**`、新环境建库与基线对齐  
...
- 分区脚本按月份拆分：目前仓库内包含 `sql/init/postgresql/partitions/init_postgresql_partitions_2025_07.sql`、`sql/init/postgresql/partitions/init_postgresql_partitions_2025_08.sql`；如需新增月份分区，应以新脚本追加（不要改历史脚本）。
