...
| `/console/capacity/instances` | 日期、周期、实例筛选联动待迁移 | 图表点位、实例容量详情钻取待迁移 | - | - | 统计当前周期结果反馈待补 |
| `/console/capacity/databases` | 日期、周期、实例/数据库筛选联动待迁移 | 图表点位、数据库容量详情钻取待迁移 | - | - | 统计当前周期结果反馈待补 |
| `/console/instance-statistics` | - | 分布图钻取、实例列表跳转待迁移 | - | - | 刷新统计结果反馈待补 |
| `/console/account-statistics` | - | 分类、规则命中和 AD 对比钻取待迁移 | - | - | 刷新统计结果反馈待补 |
| `/console/database-statistics` | - | 类型、实例分布、容量排行钻取待迁移 | - | - | 刷新统计结果反馈待补 |
...
| `/console/classification-statistics` | 分类、周期、数据库类型、实例范围筛选联动待迁移 | 规则列表、规则趋势、规则贡献钻取待迁移 | - | - | 刷新结果反馈待补 |
...
| `/console/tags` | 新建/编辑标签表单已迁移 | 标签关联资源详情待迁移 | 批量分配、批量移除、批量移除全部已迁移 | - | 删除标签确认已迁移；批量操作确认与结果反馈待补 |
