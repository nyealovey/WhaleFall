...
> 创建：2025-12-25
> 更新：2025-12-25
> 范围：`docs/changes/**` 下所有变更文档（含后续新增）
> 关联：`docs/standards/documentation-standards.md`
...
- `Draft`：方案/进度仍在讨论或推进中。
- `Active`：正在推进，且是当前真源。
- `Archived`：变更完成且无需继续更新；按 `docs/standards/documentation-standards.md` 的归档规则迁移到 `docs/_archive/changes/<category>/YYYY/`。
