...
> 状态: Draft  
> 适用人群: 开发者/贡献者  
> 目标: 从 error envelope / session / logs 快速反查到代码入口, 并给出可复制的自查命令
...
- 可观测与排障 Runbook: `docs/Obsidian/operations/observability-ops.md`
- API contract 索引: `docs/Obsidian/API/api-v1-api-contract.md`
- 错误封套与失败语义:
