...
related:
  ...
  - "[[reference/server/aggregation-pipeline|Aggregation Pipeline]]"
...
- 执行器：复用 [[reference/server/aggregation-pipeline|Aggregation Pipeline]] 的 `AggregationService.aggregate_current_period(...)`。
