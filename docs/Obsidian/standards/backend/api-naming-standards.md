---
title: API 命名与路径规范(REST Resource Naming)
aliases:
...
- MUST: 返回结构仍遵循统一 envelope (见 [[standards/backend/api-response-envelope|API 响应封套]]).
...
| 2026-01-08 | Migrate to Obsidian vault (YAML frontmatter + wikilinks). | WhaleFall Team |
