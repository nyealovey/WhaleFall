---
title: API Contract Canvas 标准(Deprecated)
aliases:
  - api-contract-canvas-standards
tags:
  - standards
  - standards/backend
  - api/contract
...
scope: "(legacy) `docs/Obsidian/canvas/**-api-contract.canvas`"
related:
  - "[[standards/backend/api-contract-markdown-standards]]"
  - "[[API/accounts-api-contract]]"
  - "[[API/api-v1-api-contract]]"
---

# [Deprecated] API Contract 画布标准
