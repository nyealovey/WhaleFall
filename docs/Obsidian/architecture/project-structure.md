...
| `migrations/` | 数据库迁移 | 约束见 `docs/Obsidian/standards/backend/standard/database-migrations.md` |
...
- 迁移: `migrations/**`
  - 约束: 不修改历史 migration.
  - 规范: `docs/Obsidian/standards/backend/standard/database-migrations.md`
- 初始化/运维 SQL: `sql/**`
