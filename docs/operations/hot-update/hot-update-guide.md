...
- `.env` 存在且包含生产密钥（详见 `../../standards/backend/configuration-and-secrets.md`）。
...
- `../../reference/database/schema-baseline.md`
