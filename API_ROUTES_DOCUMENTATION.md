...
| 路径 | 方法 | 描述 |
|------|------|------|
| `/aggregations/` | GET | 统计聚合页面（无查询参数时） |
| `/aggregations/instance` | GET | 实例统计聚合页面（无查询参数时） |
| `/aggregations/database` | GET | 数据库统计聚合页面（无查询参数时） |
...
| 路径 | 方法 | 描述 |
|------|------|------|
| `/instances/<int:id>/delete` | POST | 删除实例 |
| `/instances/<int:id>/toggle` | POST | 启用/禁用实例 |
| `/instances/api/instances` | GET | 获取实例列表 API |
